...
public class CustomUser implements CustomUserDetails, CredentialsContainer {
    ...
    public CustomUser(String username, long userId, String password,
                Collection<? extends GrantedAuthority> authorities) {
        this(username, userId, password, true, true, true, true, authorities);
    }

    public CustomUser(String username,long userId, String password, boolean enabled,
    ...
    public static CustomUser.UserBuilder withUserId(long userId) {
    ...
    public static CustomUser.UserBuilder withUserDetails(CustomUserDetails userDetails) {
    ...
    public static class UserBuilder {
        ...
        public CustomUser.UserBuilder userId(long userId) {
        ...
        public CustomUserDetails build() {
            ...
            return new CustomUser(username, userId, encodedPassword, !disabled, !accountExpired,
